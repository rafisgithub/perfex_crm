...
<div id="header">
    ...
    <nav class="tw-flex tw-justify-between">
        <div class="tw-flex">
            <div id="top_search" class="tw-inline-flex tw-relative dropdown sm:tw-ml-1.5 sm:tw-mr-3 tw-max-w-xl"
        ...
        <div class="mobile-menu">
            ...
            <ul class="mobile-icon-menu tw-inline-flex tw-mt-5 tw-space-x-2.5">
                <?php
               // To prevent not loading the timers twice
            if (is_mobile()) { ?>
                <li class="dropdown notifications-wrapper header-notifications tw-block">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="icon header-user-profile" data-toggle="tooltip" title="<?php echo get_staff_full_name(); ?>"
                ...
                <a href="#" class="dropdown-toggle profile tw-block rtl:tw-pl-0 !tw-py-1" data-toggle="dropdown"
                    aria-expanded="false">
            ...
            <li class="icon header-timers timer-button tw-relative ltr:tw-mr-1.5 rtl:tw-ml-1.5" data-placement="bottom"
                data-toggle="tooltip" data-title="<?php echo _l('my_timesheets'); ?>">
                <a href="#" id="top-timers" class="top-timers !tw-px-0 tw-group" data-toggle="dropdown">
                    <span
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="tw-w-5 tw-h-5 tw-text-neutral-900 tw-shrink-0<?php echo  count($startedTimers) > 0 ? ' tw-animate-spin' : ''; ?>">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </span>
