            ...
            if (isset($share_contacts_id) && count($share_contacts_id) > 0) {
                ...
                if ($names != '') {
                    ...
                    <td>
                        ...
                        <button type="button" data-toggle="modal" data-file-name="<?php echo $_att['file_name']; ?>"
                            data-filetype="<?php echo $_att['filetype']; ?>" data-path="<?php echo $path; ?>"
                            data-target="#send_file" class="btn btn-primary btn-icon"><i
                                class="fa-regular fa-envelope"></i></button>
                        <?php } elseif (isset($_att['external']) && !empty($_att['external'])) {
            echo '<a href="' . $_att['external_link'] . '" class="btn btn-primary btn-icon" target="_blank">' . ($_att['external'] == 'dropbox' ? '<i class="fa fa-dropbox"></i>' : '<i class="fa-brands fa-google"></i>') . '</a>';
        } ?>
