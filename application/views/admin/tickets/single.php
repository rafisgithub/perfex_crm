                            ...
                            <div role="tabpanel" class="tab-pane <?php if (!$this->session->flashdata('active_tab')) {
                                ...
                                <div class="row">
                                    <div class="col-md-12 mbot15">
                                        <h4 class="tw-font-semibold tw-text-lg tw-mt-0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="tw-flex tw-justify-between">
                                                                <span class="bold tw-flex tw-items-center tw-space-x-2">
                                                                    <?php echo staff_profile_image($note['addedfrom'], ['staff-profile-xs-image']); ?>
                                                                    <a href="<?php echo admin_url('staff/profile/' . $note['addedfrom']); ?>"
                                                                        class="tw-text-warning-700 hover:tw-text-warning-900"><?php echo _l('ticket_single_ticket_note_by', get_staff_full_name($note['addedfrom'])); ?>
                                                                    </a>
                                                                </span>
                                                                <?php
                                                            ...
                                                            <hr class="tw-my-4 tw-border-warning-200 -tw-mx-4" />
                                                            ...
                                                            <span
                                                                class="tw-font-medium tw-text-sm tw-mt-2 tw-inline-block">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo admin_url('tickets/delete/' . $ticket->ticketid); ?>"
                                        class="btn btn-danger btn-sm _delete btn-ticket-label mright5">
                                        <i class="fa fa-remove"></i>
                                    </a>
