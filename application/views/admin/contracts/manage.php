            ...
            <div class="col-md-12">
                <div class="_buttons">
                    ...
                    <div class="row" id="contract_summary">
                        ...
                        <div
                            class="col-md-2 col-xs-6 tw-border-r tw-border-solid tw-border-neutral-300 tw-inline-flex tw-items-center">
                        ...
                        <div class="col-md-2 col-xs-6 tw-inline-flex tw-items-center">
                            <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
