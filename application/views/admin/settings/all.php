...
foreach ($tabs as $group) { ?>
    ...
    ?>
                ...
                <a href="<?php echo admin_url('settings?group=update'); ?>"
                    class="tw-flex tw-items-center tw-mb-2 settings-group-system-update<?php echo $this->input->get('group') == 'update' ? 'bold': ''; ?>">
        ...
        ?>
                <a href="<?php echo admin_url('settings?group=info'); ?>"
                    class="tw-flex tw-items-center settings-group-system-info<?php echo $this->input->get('group') == 'info' ? 'bold' : ''; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="tw-w-5 tw-h-5 tw-mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round"
