                                ...
                                <div class="feed-item">
                                    <div class="date">
                                        <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo _dt($history->date); ?>">
                                            <?php echo time_ago($call_log->date); ?>
                                        </span>
                                    </div>
                                    <div class="text">
                                        <?php if (!empty($call_log->lead_name)) { ?>
                                            Lead Name: <?php echo htmlspecialchars($call_log->lead_name); ?><br>
                                        <?php } ?>
                                        <?php if (!empty($call_log->lead_id)) { ?>
                                            Lead ID: <?php echo htmlspecialchars($call_log->lead_id); ?><br>
                                        <?php } ?>

                                        <?php if (!empty($call_log->recording)) { ?>
                                       
                                            <audio controls style="width: 100px; height: 30px;">
                                                <source src="<?php echo base_url('modules/mp3-addons/assets/recording/' . $call_log->recording); ?>" type="audio/mpeg">
