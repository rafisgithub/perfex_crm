    ...
    echo 'active';
        ...
        ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div
                            class="tw-flex tw-flex-wrap tw-flex-col md:tw-flex-row tw-w-full tw-gap-6 tw-mt-2 sm:tw-mt-4">
                            <?php foreach (subscriptions_summary() as $summary) { ?>
                            <div
                                class="tw-border-r tw-border-solid tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center last:tw-border-r-0">
