...
<div class="col-md-12 comment-item" data-commentid="<?php echo $comment['id']; ?>">
   ...
   <a href="#" class="pull-right mright5" onclick="toggle_contract_comment_edit(<?php echo $comment['id']; ?>);return false;"><i class="fa-regular fa-pen-to-square"></i></a>
   </a>
   <?php } ?>
   <div class="media-body">
      ...
      <div data-contract-comment-edit-textarea="<?php echo $comment['id']; ?>" class="hide mtop15">
         ...
         <div class="text-right">
            ...
            <button type="button" class="btn btn-primary" onclick="edit_contract_comment(<?php echo $comment['id']; ?>);"><?php echo _l('update_comment'); ?></button>
         </div>
         <?php } ?>
      </div>
   </div>
