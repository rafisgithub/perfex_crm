<div class="cb-form-wrapper pfxcbcontent">
    ...
    <div class="col-6 message_wrapper">
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="" name="client_firstname" id="client_firstname">
        </div>
        <div class="form-group">
            <label for="client_lastname"><?= _l('callbacks_form_lastname'); ?></label>
            <input type="text" class="form-control" value="" name="client_lastname" id="client_lastname">
        </div>

        <div class="form-group">
            <label for="client_email"><?= _l('callbacks_form_your_email'); ?></label>
            <input type="email" class="form-control" value="" name="client_email" id="client_email">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="tel" class="form-control" value="" name="client_phone" id="client_phone">
        </div>
