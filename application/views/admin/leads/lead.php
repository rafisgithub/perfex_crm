        ...
        <div class="col-md-12">
                        ...
                        <div class="horizontal-tabs">
                            <ul class="nav-tabs-horizontal nav nav-tabs<?php if (!isset($lead)) {
                                ...
                                <?php if (isset($lead)) { ?>
                                    ...
                                    <li role="presentation">
                                        <a href="#ringcental_history" aria-controls="ringcental_history" role="tab" data-toggle="tab">
                                            <?php echo _l('ringcentral_tab'); ?>
                                        </a>
                                    </li>
            ...
            <div class="tab-content mtop20">
                ...
                <?php if (isset($lead)) { ?>
                    ...
                    <div role="tabpanel" class="tab-pane" id="ringcental_history">
                        <div class="activity-feed">
                            <?php foreach ($ringcentral_history as $history) { ?>

                                <div class="feed-item">
                                    <div class="date">
                                        <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo _dt($history->date); ?>">
                                            <?php echo time_ago($history->date); ?>
                                        </span>
                                    </div>
                                    <div class="text">
                                        <?php if (!empty($history->lead_name)) { ?>
                                            Lead Name: <?php echo htmlspecialchars($history->lead_name); ?><br>
                                        <?php } ?>
                                        <?php if (!empty($history->lead_id)) { ?>
                                            Lead ID: <?php echo htmlspecialchars($history->lead_id); ?><br>
                                        <?php } ?>

                                        <?php if (!empty($history->recording)) { ?>
                                       
                                            <audio controls style="width: 100px; height: 30px;">
                                                <source src="<?php echo base_url('modules/ringcentral/asset/recording/' . $history->recording); ?>" type="audio/mpeg">
                        ...
                        <div class="col-md-12">
                            <?php echo render_textarea('ringcentral_activity_textarea', '', '', ['placeholder' => _l('enter_activity')], [], 'mtop15'); ?>
                            <div class="text-right">
                                <button id="ringcentral_enter_activity" class="btn btn-primary"><?php echo _l('submit'); ?></button>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_proposals_leads">
                        <?php if (has_permission('proposals', '', 'create')) { ?>
                            <a href="<?php echo admin_url('proposals/proposal?rel_type=lead&rel_id=' . $lead->id); ?>" class="btn btn-primary mbot25"><?php echo _l('new_proposal'); ?></a>
                        <?php } ?>
                        <?php if (total_rows(db_prefix() . 'proposals', ['rel_type' => 'lead', 'rel_id' => $lead->id]) > 0 && (has_permission('proposals', '', 'create') || has_permission('proposals', '', 'edit'))) { ?>
                            <a href="#" class="btn btn-primary mbot25" data-toggle="modal" data-target="#sync_data_proposal_data"><?php echo _l('sync_data'); ?></a>
                    ...
                    <div role="tabpanel" class="tab-pane" id="lead_reminders">
                        <a href="#" data-toggle="modal" class="btn btn-default" data-target=".reminder-modal-lead-<?php echo $lead->id; ?>"><i class="fa-regular fa-bell"></i>
                    ...
                    <div role="tabpanel" class="tab-pane" id="lead_notes">
                        ...
                        <button type="submit" class="btn btn-primary pull-right"><?php echo _l('lead_add_edit_add_note'); ?></button>
                        <?php echo form_close(); ?>
                        <div class="clearfix"></div>
                        <hr />
                        <?php
                            ...
                            <div class="media lead-note">
                                ...
                                <div class="media-body">
                                    <?php if ($note['addedfrom'] == get_staff_user_id() || is_admin()) { ?>
                                        <a href="#" class="pull-right text-danger" onclick="delete_lead_note(this,<?php echo $note['id']; ?>, <?php echo $lead->id; ?>);return false;">
