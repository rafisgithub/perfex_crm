               ...
               <div class="col-md-12">
                    <div class="panel_s">
                         <div class="panel-body">
                              <div class="_buttons">
                                   <a data-toggle="tooltip" title="<?= _l('appointly_back_to_appointments'); ?>" href="<?= admin_url('appointly/appointments'); ?>" id="backToAppointments" class="btn btn-info pull-left display-block">
