    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group select-placeholder <?php if($rel_type!='lead') echo 'hide'; ?>" id="rel_id_wrapper">
                        ...
                        <div class="form-group select-placeholder">
                            ...
                            <select name="rel_type" id="rel_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <option value=""></option>
                                <option <?php if($rel_type=='lead') echo 'selected'; ?> id="lead_related" value="lead_related"><?= _l('lead'); ?></option>
            ...
            <div class="modal-footer">
                <input type="hidden" name="redirect_lead" value="<?php echo $redirect_lead; ?>">
